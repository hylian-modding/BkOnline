...
export class BkOnline implements IPlugin {
    ...
    handle_permanence_counts() {
        ...
        // Handle Level Jinjos
        {
            this.core.save.inventory.jinjos = this.cDB.level_data[level].jinjos
        }
    ...
    onTick(): void {
        ...
        // Refresh Map State
        if (this.cDB.inst_refresh_state === 1) {
            // Reset state
            this.cDB.inst_refresh_state = 0;
